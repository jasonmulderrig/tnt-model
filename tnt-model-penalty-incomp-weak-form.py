...
# plt.savefig(savedir+"u_1_vs_t.eps", format='eps', dpi=1000, transparent=True)
plt.close()
...
# plt.savefig(savedir+"lambda_1_vs_t.eps", format='eps', dpi=1000, transparent=True)
plt.close()
...
# plt.savefig(savedir+"sigma_G_vs_lambda_1.eps", format='eps', dpi=1000, transparent=True)
plt.close()
...
# plt.savefig(savedir+"F_vs_lambda_1.eps", format='eps', dpi=1000, transparent=True)
plt.close()
...
# plt.savefig(savedir+"L_prior_vs_lambda_1.eps", format='eps', dpi=1000, transparent=True)
plt.close()
...
# plt.savefig(savedir+"mu_vs_lambda_1.eps", format='eps', dpi=1000, transparent=True)
plt.close()
...
# plt.savefig(savedir+"Psi_vs_lambda_1.eps", format='eps', dpi=1000, transparent=True)
plt.close()